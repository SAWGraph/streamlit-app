...
def build_registry() -> dict[str, AnalysisSpec]:
    ...
    specs = [
        AnalysisSpec(
            ...
            description="Trace potential PFAS sources upstream from sampling locations.",
            query=1,
            enabled=True,
        ...
        AnalysisSpec(
            ...
            description="Explore downstream transport and impacted sampling locations.",
            query=5,
            enabled=True,
        ...
        AnalysisSpec(
            ...
            description="Find and summarize samples located near known facilities.",
            query=2,
            enabled=True,
